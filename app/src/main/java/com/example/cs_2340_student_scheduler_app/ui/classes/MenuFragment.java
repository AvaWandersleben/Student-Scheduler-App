...
//                        MenuFragmentDirections.actionNavigationAddClassToNavigationDashboard(courseNameStr, instructNameStr, timeTextStr);
                ...
                navController.getPreviousBackStackEntry().getSavedStateHandle().set("course", courseNameStr);
                navController.getPreviousBackStackEntry().getSavedStateHandle().set("time", timeTextStr);
                navController.getPreviousBackStackEntry().getSavedStateHandle().set("instructor", instructNameStr);
